...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] [Range(0f, 1f)] private float m_RunstepLenghten = 0.1f;
        [SerializeField] private float m_JumpSpeed = 2f;
        [SerializeField] private float m_StickToGroundForce = 0.1f;
        [SerializeField] private float m_GravityMultiplier = 9f;
