...
namespace VolumetricFogAndMist {
	...
	public class VolumetricFogProfileInspector : Editor {
		...
		SerializedProperty lightScatteringOverride, lightScatteringEnabled, lightScatteringDiffusion, lightDiffusionSpread, lightScatteringExposure, lightScatteringSpread, lightScatteringWeight, lightScatteringIllumination, lightScatteringDecay, lightScatteringSamples, lightScatteringTint, lightScatteringJittering, lightScatteringBlurDownscale;
		...
		void OnEnable() {
            ...
            lightDiffusionSpread = serializedObject.FindProperty("lightDiffusionSpread");
			...
			lightScatteringTint = serializedObject.FindProperty("lightScatteringTint");
		...
		public override void OnInspectorGUI() {
			...
			if (lightScatteringEnabled.boolValue) {
				EditorGUILayout.PropertyField(lightScatteringDiffusion, new GUIContent("Diffusion", "Intensity of Sun light scattering."));
                EditorGUILayout.PropertyField(lightDiffusionSpread, new GUIContent("   Spread", "Spread or intensity of Sun light scattering."));
				...
				EditorGUILayout.PropertyField(lightScatteringTint, new GUIContent("   Tint Color", "Optional tint color. Use alpha value to control the tint intensity."));
