...
namespace VolumetricFogAndMist {
    ...
    public class VolumetricFogInspector : Editor {
        ...
        SerializedProperty _lightScatteringEnabled, _lightScatteringDiffusion, _lightDiffusionSpread, _lightScatteringExposure, _lightScatteringSpread, _lightScatteringWeight, _lightScatteringIllumination, _lightScatteringDecay, _lightScatteringSamples, _lightScatteringTint, _lightScatteringJittering, _lightScatteringBlurDownscale;
        ...
        SerializedProperty _downsampling, _forceComposition, _blurComposition, _blurEdgeThreshold, _edgeImprove, _edgeThreshold, _stepping, _steppingNear, _dithering, _ditherStrength, _jitterStrength, _useSinglePassStereoRenderingMatrix, _updateTextureSpread, _timeBetweenTextureUpdates;
        ...
        void OnEnable() {
            ...
            _lightDiffusionSpread = serializedObject.FindProperty("_lightDiffusionSpread");
            ...
            _lightScatteringTint = serializedObject.FindProperty("_lightScatteringTint");
            ...
            _blurComposition = serializedObject.FindProperty("_blurComposition");
            _blurEdgeThreshold = serializedObject.FindProperty("_blurEdgeThreshold");
...
#pragma warning disable 0162
                    if (VolumetricFog.LIGHT_DIFFUSION_ENABLED) {
                        EditorGUILayout.PropertyField(_lightScatteringDiffusion, new GUIContent(VolumetricFog.LIGHT_DIFFUSION_MIE ? "Diffusion (Mie)" : "Diffusion", "Intensity of Sun light scattering."));
                        EditorGUILayout.PropertyField(_lightDiffusionSpread, new GUIContent("   Spread", "Spread of Sun light scattering."));
                    } else {
                        EditorGUILayout.BeginHorizontal();
...
#pragma warning restore 0429
                    ...
                    EditorGUILayout.PropertyField(_lightScatteringTint, new GUIContent("   Tint Color", "Optional tint color. Use alpha value to control the tint intensity."));
...
#pragma warning restore 0429
                ...
                if (expandFogOfWarSection) {
                    ...
                    if (_fogOfWarEnabled.boolValue) {
                        ...
                        if (_fogOfWarReuseOther.boolValue) {
                            ...
                            if (_fog.fogOfWarOther != null && GUILayout.Button("Select Fog Of War Holder")) {
            ...
            if (expandOptimizationSettingsSection) {
                ...
                if (_downsampling.intValue > 1 || _forceComposition.boolValue) {
                    EditorGUILayout.PropertyField(_blurComposition, new GUIContent("   Blur", "Applies a Gaussian blur to the computed fog buffer."));
                    if (_blurComposition.boolValue)
                    {
                        EditorGUILayout.PropertyField(_blurEdgeThreshold, new GUIContent("      Edge Threshold", "Depth threshold used to detected edges."));
                    }
                    ...
                    if (_edgeImprove.boolValue) {
                        EditorGUILayout.PropertyField(_edgeThreshold, new GUIContent("      Edge Threshold", "Depth threshold used to detected edges."));
                    }
                }
                ...
                if (_fog.hasCamera) {
                    EditorGUILayout.PropertyField(_useSinglePassStereoRenderingMatrix, new GUIContent("Single Pass Stereo", "Enables Single Pass Stereo Rendering when using in VR."));
