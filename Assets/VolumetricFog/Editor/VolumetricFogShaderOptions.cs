    ...
    public class VolumetricFogShaderOptions {
        ...
        public void ReadOptions() {
            ...
            options = new ShaderAdvancedOption[]
            {
                ...
                new ShaderAdvancedOption
                {
                    id = "FOG_MIE_DIFFUSION",
                    name = "Mie Scattering",
                    description = "Uses Mie model for calculation of diffusion of Sun light."
                },
                new ShaderAdvancedOption
                {
                ...
                new ShaderAdvancedOption
                {
                    ...
                    description = "Use blue noise texture alternative for jittering which can produce a more uniform noise distribution. If blur option is enabled in Optimization options, this option won't produce significant difference."
                },
                new ShaderAdvancedOption
                {
        ...
        public void UpdateAdvancedOptionsFile() {
            ...
            if (shader != null) {
                ...
                bool useMieDiffusion = GetAdvancedOptionState("FOG_MIE_DIFFUSION");
                ...
                if (!File.Exists(file)) {
                    ...
                    for (int k = 0; k < lines.Length; k++) {
                        ...
                        } else if (lines[k].Contains("LIGHT_DIFFUSION_MIE")) { 
                            string value = useMieDiffusion ? "true" : "false";
                            lines[k] = "public const bool LIGHT_DIFFUSION_MIE = " + value + ";";
