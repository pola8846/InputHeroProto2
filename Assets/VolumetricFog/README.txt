...
v12.0
- Added "Diffusion Spread" setting
- Added "Mie based scattering" option in Shader Options

v11.9
- VR configuration changes: dropped Single Pass Autodetection Behaviour option. Now just use the Single Pass Stereo option.

v11.8
- Added DemoIntegration scene with examples of integrated fog with vertex/fragment and surface shaders

v11.7
- Multithreading support to internal texture updates for improved performance

v11.6
- API: added SetFogOfWarAlpha overload that accepts a gameobject
- [Fix] Fixed fog area z position being ignored when XY Plane option is enabled
